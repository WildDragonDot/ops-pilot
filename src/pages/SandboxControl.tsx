...
import { Zap, Play, RotateCcw, AlertTriangle, CheckCircle2, Server, Database, Activity, Cpu } from 'lucide-react';
...
export const SandboxControl: React.FC<SandboxControlProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Current System Status Inspector */}
