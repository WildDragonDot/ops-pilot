...
function githubAstRootCause(gitUrl, gitBranch = 'main') {
...
function normalizeIncidentForProject(incident) {
    ...
    const normalized = {
        ...
        rootCause: isGitOnly && hasStaleServerText
            ? githubAstRootCause(project.gitUrl, project.gitBranch || 'main')
            : incident.rootCause,
