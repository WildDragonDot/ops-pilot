...
export const TerminalConsole: React.FC<TerminalConsoleProps> = ({ events, incidentId }) => {
  ...
  return (
    <div className="rounded-2xl border border-slate-800 bg-[#050811] overflow-hidden shadow-2xl space-y-0">
      
      {/* Console Header Bar */}
      <div className="px-4 py-3 bg-[#0a0f1d] border-b border-slate-800 flex items-center justify-between font-mono text-xs">
        <div className="flex items-center gap-2">
          ...
          <span className="text-slate-200 font-bold">opspilot-agent-cli --incident={incidentId}</span>
        </div>
      ...
      <div className="p-4 max-h-96 overflow-y-auto space-y-3 font-mono text-xs leading-relaxed">
