        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-xs font-semibold">
              ...
              <span>ChatGPT & Codex Hackathon 2026 Edition</span>
            </div>
            <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-white">
              Production Failure Commander & GitHub Intelligence
            </h1>
            <p className="text-sm text-slate-300 max-w-2xl">
              OpsPilot AI uses OpenAI GPT-4o tool calling to inspect your GitHub repository for code risks, investigate production outages, correlate commit diffs, propose safe fixes, and wait for human approval before execution.
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 glass-panel p-5 rounded-2xl border border-slate-800 space-y-4">
          <div className="flex items-center justify-between border-b border-slate-800 pb-3">
            ...
            <span className="text-xs font-mono text-slate-400">Backend API: Port 5000</span>
          </div>
        ...
        <div className="glass-panel p-5 rounded-2xl border border-slate-800 space-y-4 flex flex-col justify-between">
          <div className="space-y-2">
            ...
            <p className="text-xs text-slate-400">
              Inject real-world production failures to test OpsPilot AI's automated OpenAI tool calling & recovery loop.
            </p>
          </div>
