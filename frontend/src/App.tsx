    ...
    <div className="min-h-screen bg-[#090d16] text-slate-100 flex flex-col font-sans">
      ...
      <footer className="border-t border-slate-800/80 bg-[#090d16]/90 py-6 text-center text-xs text-slate-500">
        <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          <span>OpsPilot AI — ChatGPT & Codex Hackathon 2026 Production Agent</span>
          <span className="font-mono text-slate-400">Backend Server: Port 5000 | Frontend: Port 3000</span>
        </div>
      </footer>
    </div>
  );
